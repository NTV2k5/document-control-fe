  ...
  useEffect(() => {
    ...
    const loadMockData = (name: string, category: TMimeCategory) => {
      ...
      if (ext === 'docx') {
        ...
        // Minimal valid PDF document base64 (displays a standard page with a custom text message)
        const minimalPdfBase64 = "";
        try {
